...
declare -a datasets=(
    ...
    # "due_benchmark/DocVQA --max_train_samples 100 --max_validation_samples 100 --max_test_samples 100 --num_processes 0"  
)


for dataset_entry in "${datasets[@]}"; do
    echo "Processing dataset: $dataset_entry"
    uv run atria datasets prepare_and_upload $dataset_entry $@
done