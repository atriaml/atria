...
class SequenceModelExplanationPipelineConfig(ExplanationPipelineConfig):
    ...
    def validate_configs(self) -> SequenceModelExplanationPipelineConfig:
...
T_SequenceModelExplanationPipelineConfig = TypeVar(
    "T_SequenceModelExplanationPipelineConfig",
    bound="SequenceModelExplanationPipelineConfig",
)
...
@EXPLANATION_PIPELINES.register("sequence_classification")
class SequenceClassificationExplanationPipeline(
    SequenceModelExplanationPipeline[SequenceClassificationExplanationPipelineConfig]
):
    __config__ = SequenceClassificationExplanationPipelineConfig


class TokenClassificationExplanationPipelineConfig(
    SequenceModelExplanationPipelineConfig
):
...
@EXPLANATION_PIPELINES.register("token_classification")
class TokenClassificationExplanationPipeline(
    SequenceModelExplanationPipeline[TokenClassificationExplanationPipelineConfig]
):
    __config__ = TokenClassificationExplanationPipelineConfig
...
@EXPLANATION_PIPELINES.register("layout_token_classification")
class LayoutTokenClassificationExplanationPipeline(
    SequenceModelExplanationPipeline[LayoutTokenClassificationExplanationPipelineConfig]
):
    __config__ = LayoutTokenClassificationExplanationPipelineConfig
...
@EXPLANATION_PIPELINES.register("question_answering")
class QuestionAnsweringExplanationPipeline(SequenceModelExplanationPipeline):
    __config__ = QuestionAnsweringExplanationPipelineConfig
