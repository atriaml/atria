...
class SequenceClassificationExplanationPipeline(ExplanationPipeline):
    def __init__(
        self,
        model_pipeline: SequenceClassificationPipeline,
        is_multi_target: bool = False,
        group_tokens_to_words: bool = True,
        baselines_config: dict[str, str] | None = None,
        metric_baselines_config: dict[str, str] | None = None,
    ):
