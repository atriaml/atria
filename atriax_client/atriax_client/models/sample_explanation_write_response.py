...
if TYPE_CHECKING:
    ...
    from ..models.sample_explanation_write_response_explanation_metadata import (
        SampleExplanationWriteResponseExplanationMetadata,
    )


T = TypeVar("T", bound="SampleExplanationWriteResponse")


@_attrs_define
class SampleExplanationWriteResponse:
    """
    Attributes:
        id (UUID):
        created_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        explanation_metadata = SampleExplanationWriteResponseExplanationMetadata.from_dict(
            d.pop("explanation_metadata")
        )
        ...
        sample_explanation_write_response = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            sample_index=sample_index,
        ...
        sample_explanation_write_response.additional_properties = d
        return sample_explanation_write_response
