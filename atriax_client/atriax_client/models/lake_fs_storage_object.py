...
class LakeFSStorageObject:
    ...
    object_key: str
    ext: str
    physical_address: None | Unset | str = UNSET
    presigned_url: None | Unset | str = UNSET
    size: Unset | int = 0
    modified: Unset | int = 0
    type_: Unset | str = "file"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_physical_address(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_presigned_url(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
