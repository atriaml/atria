...
T = TypeVar("T", bound="ConfigSaveChildrenType0")
...
class ConfigSaveChildrenType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        config_save_children_type_0 = cls()
        ...
        for prop_name, prop_dict in d.items():
            ...
            def _parse_additional_property(data: object) -> ConfigSave | list[ConfigSave]:
                ...
                for additional_property_type_1_item_data in _additional_property_type_1:
                    additional_property_type_1_item = ConfigSave.from_dict(additional_property_type_1_item_data)
        ...
        config_save_children_type_0.additional_properties = additional_properties
        return config_save_children_type_0
