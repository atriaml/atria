...
def _get_kwargs(
    ...
    *,
    body: Union["SampleEvaluationCreate", list["SampleEvaluationCreate"]],
) -> dict[str, Any]:
...
) -> HTTPValidationError | Union["SampleEvaluation", list["SampleEvaluation"]] | None:
    if response.status_code == 200:

        def _parse_response_200(data: object) -> Union["SampleEvaluation", list["SampleEvaluation"]]:
            try:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | Union["SampleEvaluation", list["SampleEvaluation"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[HTTPValidationError, Union['SampleEvaluation', list['SampleEvaluation']]]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, Union['SampleEvaluation', list['SampleEvaluation']]]
    """
