...
from atria_typesfactory import DocumentInstanceFactory
...
class TestDocumentInstance(DataModelTestBase):
    ...
    def expected_table_schema(self) -> dict[str, pa.DataType]:
        ...
        return {
            ...
            "content": {
                ...
                "word_bboxes": {
                    "value": pa.list_(pa.list_(pa.float64())),
                    "mode": pa.string(),
                },
                ...
                "word_confs": pa.list_(pa.float64()),
                "word_angles": pa.list_(pa.float64()),
            },
    ...
    def expected_table_schema_flattened(self) -> dict[str, pa.DataType]:
        ...
        return {
            ...
            "content_words": pa.list_(pa.string()),
            "content_word_bboxes_value": pa.list_(pa.list_(pa.float64())),
            "content_word_bboxes_mode": pa.string(),
            "content_word_segment_level_bboxes_value": pa.list_(pa.list_(pa.float64())),
            "content_word_segment_level_bboxes_mode": pa.string(),
            "content_word_confs": pa.list_(pa.float64()),
            "content_word_angles": pa.list_(pa.float64()),
            "annotations": pa.string(),
