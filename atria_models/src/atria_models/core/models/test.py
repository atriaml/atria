...
from atria_models.core.models.transformers._encoder_model._model import (
...
def load_bert_model_clean() -> TransformersEncoderModel:
    # model = BertModelClean.from_pretrained("bert-base-uncased")
    model = TransformersEncoderModel(TransformersEncoderModelConfig())
