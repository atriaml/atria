...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        print("self.layer_norm", self.LayerNorm)
    ...
    def forward(
        ...
        print("inputs_embeds", inputs_embeds.sum())
        print("token_type_embeddings", token_type_embeddings.sum())
        embeddings = inputs_embeds + token_type_embeddings
        if self.position_embedding_type == "absolute":
            position_embeddings = self.position_embeddings(position_ids)
            print("position_embeddings", position_embeddings.sum())
            embeddings += position_embeddings
        print("agg1", embeddings.sum())
...
class BertEncoder(nn.Module):
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            print("hidden_states", hidden_states.shape, hidden_states.sum())
            if use_cache:
