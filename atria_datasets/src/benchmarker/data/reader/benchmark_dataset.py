...
class BenchmarkDataset(Dataset):
    ...
    def __iter__(self) -> Iterator[Document]:
        ...
        with (
            open(docs_jsonl_path) as docs_file,
            open(docs_content_jsonl_path) as docs_content_file,
        ):
            for doc_line, doc_content in zip(docs_file, docs_content_file, strict=True):
...
class BenchmarkCorpusMixin:
    def read_benchmark_challenge(self, directory: str | Path, **kwargs):
