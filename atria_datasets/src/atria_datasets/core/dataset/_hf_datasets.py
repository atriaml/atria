...
class HuggingfaceDataset(
    ...
    __abstract__ = True
    __config__: type[T_HuggingfaceDatasetConfig] = HuggingfaceDatasetConfig  # type: ignore[assignment]

    def __init__(self, config: T_HuggingfaceDatasetConfig) -> None:
        super().__init__(config=config)
        self.__hf_dataset_builder: datasets.DatasetBuilder | None = None
        self._hf_split_generators: dict | None = None
    ...
    def _split_iterator(self, split: DatasetSplitType, data_dir: str) -> Iterable:  # noqa: ARG002
